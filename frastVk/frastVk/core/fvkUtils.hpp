...
inline const std::string errorToString(const VkResult& r) {
	switch (r) {
...
// Right now, this throws on a failed vulkan call.
// TODO: If NDEBUG exit(1) isntead of throw
#define assertCallVk(F) { VkResult r = F; if (r != VK_SUCCESS) throw std::runtime_error("vk call failed with " + errorToString(r)); }
